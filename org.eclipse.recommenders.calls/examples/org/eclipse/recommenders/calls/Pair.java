...
public class Pair<T0, T1> {
    ...
    public static <T0, S0 extends T0, T1, S1 extends T1> Pair<T0, T1> newTuple(final S0 t0, final S1 t1) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof Pair) {
            ...
            return safeEquals(t0, test.t0) && safeEquals(t1, test.t1);
        }
        return false;
    }
