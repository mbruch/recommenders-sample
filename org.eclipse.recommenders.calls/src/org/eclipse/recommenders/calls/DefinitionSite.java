...
public class DefinitionSite {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add("kind", kind).add("sourceMethod", sourceMethod)
                .add("definedByField", definedByField).add("definedByMethod", definedByMethod).toString();
    }
}
